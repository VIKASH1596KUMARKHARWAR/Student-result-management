                        ...
                        <div className="d-flex gap-3 align-items-center dropdown">
                            ...
                            <div className="dropdown">
                                ...
                                <div className="dropdown-menu">
                                    ...
                                    <Link className="dropdown-item" to="/instructor/results">
                                        Results
                                    </Link>
                                    <Link className="dropdown-item" to="/instructor/subjects/1">
                                        Subjects (Semester 1)
                                    </Link>
                                    <Link className="dropdown-item" to="/instructor/subjects/2">
                                        Subjects (Semester 2)
                                    </Link>
                                    <Link className="dropdown-item" to="/instructor/attendance">
                                        Attendance
                                    </Link>
