...
import { getResultsByStudentId, updateResult } from  '../pages/api'; 
const EditResultForm1 = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(`/instructor/viewresult/${id}`); // Redirect to the results page
        } catch (error) {
...
export default EditResultForm1;
