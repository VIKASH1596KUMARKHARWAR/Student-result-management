...
import { getAllStudents } from '../pages/api'; // Adjust the import path based on your project structure
              ...
              <tr key={result.id} className="text-center"> {/* Center content for each row */}
                ...
                <td>
                  <button
                    ...
                    onClick={() => navigate(`/instructor/viewresult/${result.id}`)}
                  >
